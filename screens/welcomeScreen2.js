...
const WelcomeScreen2 = ({navigation}) => {
  const goToNextScreen = () => {
    ...
    navigation.navigate('welcomeScreen3'); // Replace 'NextScreen' with your actual screen name
  };

  return (
    <ImageBackground source={require('./../assets/images/image6.png')} style={styles.backgroundImage}>
      <View style={styles.container}>
        <Image style={styles.image1} source={require('./../assets/images/image1.png')} />

        <Text style={styles.text1}>Personalized</Text>

        <Text style={styles.text3}>News Feed</Text>
