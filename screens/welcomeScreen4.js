...
const WelcomeScreen4 = ({navigation}) => {
  ...
  return (
    <ImageBackground source={require('./../assets/images/image8.png')} style={styles.backgroundImage}>
      <View style={styles.container}>
        <Image style={styles.image1} source={require('./../assets/images/image1.png')} />

        <Text style={styles.text1}>24/7 Access To</Text>

        <Text style={styles.text3}>Health Counsellors</Text>
