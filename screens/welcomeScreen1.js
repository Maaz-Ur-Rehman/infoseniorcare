...
const WelcomeScreen1 = ({navigation}) => {
  const goToNextScreen = () => {
    ...
    navigation.navigate('welcomeScreen2'); // Replace 'NextScreen' with your actual screen name
  };

  return (
    <ImageBackground source={require('./../assets/images/image5.png')} style={styles.backgroundImage}>
      <View style={styles.container}>
        <Image style={styles.image1} source={require('./../assets/images/image1.png')} />

        <Text style={styles.text1}>Seamless Communication &</Text>

        <Text style={styles.text3}>Coordination</Text>
